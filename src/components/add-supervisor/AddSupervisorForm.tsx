...
export default function AddSupervisorForm({
  ...
  useEffect(() => {
    ...
    if (initialData) {
      setName(initialData.supervisorName || "");
  ...
  const validateForm = () => {
    ...
    // Optional: Uncomment if vehicle assignment is required
    // if (!deviceObjId) {
  ...
  return (
    <Card className="shadow-xl">
      <CardHeader>
        <CardTitle>
          {initialData ? "Edit Supervisor" : "Add Supervisor"}
        </CardTitle>
      </CardHeader>
