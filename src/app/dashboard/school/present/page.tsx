        ...
        <section>
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="default">Add Absent Record</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[700px] max-h-[80vh] overflow-y-auto">
              <form onSubmit={handleSubmit} className="space-y-4">
                <DialogHeader>
                  <DialogTitle>Add Absent Record</DialogTitle>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button type="submit" disabled={addAbsentMutation.isPending}>
                    {addAbsentMutation.isPending ? "Saving..." : "Save Record"}
                  </Button>
                </DialogFooter>
              </form>
            </DialogContent>
