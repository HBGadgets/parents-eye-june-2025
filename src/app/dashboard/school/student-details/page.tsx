...
export default function StudentDetails() {
  ...
  const columns: ColumnDef<Student, CellContent>[] = [
    ...
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.deviceId?.routeNo ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    ...
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.schoolId?.schoolName ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.branchId?.branchName ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    ...
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.age?.toString() ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.parentId?.parentName ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.parentId?.contactNo ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    ...
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.deviceId?.name ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.geofenceId?.name ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    ...
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.parentId?.userName ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
    {
      ...
      accessorFn: (row) => ({
        type: "text",
        value: row.parentId?.password ?? "NO DATA!!!",
      }),
      cell: (info) => info.getValue(),
      meta: { flex: 1, minWidth: 100, maxWidth: 120 },
    },
