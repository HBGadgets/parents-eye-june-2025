...
import { GetGeofenceAlertsReportColumns } from "@/components/columns/columns";
...
const GeofenceAlertsReportPage: React.FC = () => {
  ...
  } = useReport(pagination, apiFilters, "geofence-alerts");
  ...
  const columns = GetGeofenceAlertsReportColumns();

  // Table configuration
  const { table, tableElement } = CustomTableServerSidePagination({
    data: geofenceAlertsReport,
    columns,
    pagination,
